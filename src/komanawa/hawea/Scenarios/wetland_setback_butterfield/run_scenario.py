...
import pickle
import socket
from komanawa.hawea.Scenarios.wetland_setback_butterfield.scenarios import run_model_mp
...
if __name__ == '__main__':
    ...
    if len(runs) != 0:
        ...
        pool_outputs = run_multiprocess(run_model_mp, runs, num_cores=num_cores)
