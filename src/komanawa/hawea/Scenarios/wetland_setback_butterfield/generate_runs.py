...
import numpy as np
import pandas as pd
from komanawa.hawea.Scenarios.wetland_setback_butterfield.scenarios import run_model_extrac_data, get_ssh_dist, run_multiple_models, \
    wetland_name, output_suffix
from komanawa.hawea.Scenarios.wetland_setback_butterfield.model_bcs import get_wetland_loc
...
def plot_pumps():
    from komanawa.hawea.Scenarios.wetland_setback_butterfield.model_bcs import get_riv
    riv = get_riv(500)
    well = {}
    well[0] = get_run_locs()
...
def test_run():
    ...
    from komanawa.hawea.Scenarios.wetland_setback_butterfield.process_results import plot_list_failures
