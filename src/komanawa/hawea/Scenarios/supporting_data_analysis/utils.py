...
"""
import pandas as pd
from komanawa.hawea.model_build.utils import select_resample, fill_weekly_mean

def make_long_weekly_mean(data, start, stop, freq='W', only_where_na=True):
    """
    ...
    out_data = fill_weekly_mean(out_data, only_where_na=only_where_na)
