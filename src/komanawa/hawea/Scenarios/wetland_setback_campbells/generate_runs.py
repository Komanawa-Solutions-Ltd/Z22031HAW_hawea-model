...
import numpy as np
import pandas as pd
from komanawa.hawea.Scenarios.wetland_setback_campbells.scenarios import run_model_extrac_data, get_ssh_dist, run_multiple_models, \
    wetland_name, output_suffix
from komanawa.hawea.Scenarios.wetland_setback_campbells.model_bcs import get_wetland_loc
from komanawa.hawea.hawea_base import unbacked_dir
from komanawa.hawea.Scenarios.wetland_setback_campbells.project_model_tools import smt
...
def plot_pumps():
    from komanawa.hawea.Scenarios.wetland_setback_campbells.model_bcs import get_riv
    riv = get_riv(500)
    well = {}
    well[0] = get_run_locs()
...
def test_run():
    ...
    from komanawa.hawea.Scenarios.wetland_setback_campbells.process_results import plot_list_failures
