...
from komanawa.hawea.model_build.supporting_data_analysis import get_river_loc_data, get_race_locs, get_hillside_catchment_locs, \
    get_lake_hawea_loc
...
def save_opt_spd(outdir):
    ...
    from komanawa.hawea.model_build.get_boundary_condition_data import get_river_loc_data, get_race_locs, get_hillside_catchment_locs, \
        get_pumping_locs
