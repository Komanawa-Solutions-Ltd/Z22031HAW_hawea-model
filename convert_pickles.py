...
# targets_and_sensitive_sites/processed_data/min_fit_lake_g40_0415_curve.p, skipping. Error: Value for key fun is not a numpy array: <class 'numpy.float64'>
...
# targets_and_sensitive_sites/processed_data/lake_g40_0415_curve_data.p, skipping. Error: Expected data to be a dictionary, got <class 'tuple'>
