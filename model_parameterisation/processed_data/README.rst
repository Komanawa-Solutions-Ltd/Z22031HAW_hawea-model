...
- `pilot_points.csv <../processed_data/pilot_points.csv>`_: locations and identifying info for the pilot points (hk and sy)
- `rch_pilot_points.csv <../processed_data/rch_pilot_points.csv>`_: locations and identifying info for the recharge pilot points (not used in 3d model)